...
if (!defined('BX_GMAP_SCRIPT_LOADED'))
{
	...
	if ($arParams['DEV_MODE'] != 'Y')
	{
		...
		$APPLICATION->AddHeadString('<script src="'.$scheme.'://maps.google.com/maps/api/js?key=AIzaSyAFrbxLQPEBKY02GzBhHZjIj7rH1C2OWzw&sensor=false&language='.LANGUAGE_ID.'" charset="utf-8"></script>');
...
$arParams['INIT_MAP_LON'] = $arParams['INIT_MAP_LON'] ? $arParams['INIT_MAP_LON'] : 2.354261;
$arParams['INIT_MAP_LAT'] = floatval($arParams['INIT_MAP_LAT']);
$arParams['INIT_MAP_LAT'] = $arParams['INIT_MAP_LAT'] ? $arParams['INIT_MAP_LAT'] : 48.869319;
$arParams['INIT_MAP_SCALE'] = intval($arParams['INIT_MAP_SCALE']);
$arParams['INIT_MAP_SCALE'] = $arParams['INIT_MAP_SCALE'] ? $arParams['INIT_MAP_SCALE'] : 16;
